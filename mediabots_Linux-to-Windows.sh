...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://lu9-my.sharepoint.com/personal/cawmik_5tb_in/Documents/vultr/Windows_Server_2019_Halazy_Com.iso
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://lu9-my.sharepoint.com/personal/cawmik_5tb_in/Documents/vultr/Windows_Server_2019_Halazy_Com.iso
else
