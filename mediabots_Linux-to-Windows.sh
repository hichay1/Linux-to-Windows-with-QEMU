...
sudo wget -P /floppy http://42.112.17.8/PROWinx64.exe # Intel Network Adapter for Windows Server 2012 R2 
...
sudo wget -P /virtio https://fedorapeople.org/groups/virt/virtio-win/direct-downloads/latest-virtio/virtio-win.iso
